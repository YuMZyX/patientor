...
const OccupationalHealthCareForm = ({ diagnoses, patient, setPatient, setEntryForm } : Props) => {
  ...
  return (
    <Box sx={{ ...commonStyles }}>
      ...
      <TextField id="standard-basic" fullWidth label="Specialist" value={specialist}
        ...
        InputLabelProps={{ shrink: true }}/>
      <TextField id="standard-basic" fullWidth label="Employer name" value={employerName}
        variant="standard" onChange={({ target }) => setEmployerName(target.value)} 
        InputLabelProps={{ shrink: true }}/>
      ...
      <Typography variant='subtitle2' sx={{ marginTop: 1 }}>Sick leave:</Typography>
      <TextField style={{marginTop: 7, marginBottom: 7, width: 150, marginRight: 20}} type='date' id="standard-basic" value={startDate} 
        label="Start date:" variant="standard" onChange={({ target }) => setStartDate(target.value)} 
        InputLabelProps={{ shrink: true }} />
      <TextField style={{marginTop: 7, marginBottom: 7, width: 150}} type='date' id="standard-basic" value={endDate} 
        label="End date:" variant="standard" onChange={({ target }) => setEndDate(target.value)} 
        InputLabelProps={{ shrink: true }} />
